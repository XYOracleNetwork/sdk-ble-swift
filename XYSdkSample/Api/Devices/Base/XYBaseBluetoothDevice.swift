...
//public class XYBaseFinderDevice: XYBaseBluetoothDevice, XYFinderDevice {
//    public var family: XYFinderDeviceFamily
//
//    public var iBeacon: XYIBeaconDefinition?
//
//    public var connectableServices: [CBUUID]
//}

public class XYBaseBluetoothDevice: NSObject, XYBluetoothBase {

    fileprivate static var counter = 1

    public var rssi: Int = XYDeviceProximity.none.rawValue
...
extension XYBaseBluetoothDevice {
...
public extension XYBaseBluetoothDevice {
...
extension XYBaseBluetoothDevice: CBPeripheralDelegate {
...
public extension XYBaseBluetoothDevice {
    ...
    func connection(_ operations: @escaping () throws -> Void) -> Promise<Void> {
        ...
        return Promise<Void>(on: XYBaseBluetoothDevice.workQueue, operations)
    }
